  ...
  const projects = [
    {
      ...
      description: "A minimalist, responsive portfolio website built with React and Tailwind CSS.",
      tags: ["React", "TypeScript", "Tailwind CSS"],
      image: "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?q=80&w=800&auto=format",
    ...
    },
    {
      ...
      description: "A modern e-commerce solution with product management, cart functionality, and payment processing.",
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project, index) => (
            <Card key={index} className="glass-card overflow-hidden flex flex-col h-full">
